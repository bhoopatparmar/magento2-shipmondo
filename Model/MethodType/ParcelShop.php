...
class ParcelShop extends AbstractParcelShop implements MethodTypeHandlerInterface
{
    ...
    public function __construct(
        ...
        parent::__construct($jsonSerializer, $dataObjectHelper, $objectFactory, $parcelShopClass);
    }
        ...
        if ($parcelShop->getNumber()) {
            $order->getShippingAddress()->addData([
                ...
                OrderAddressInterface::STREET => [
                    $parcelShop->getStreetName() . ' Pakkeshop: ' . $parcelShop->getNumber()
                ],
                ...
                OrderAddressInterface::FAX => $parcelShop->getNumber(),
